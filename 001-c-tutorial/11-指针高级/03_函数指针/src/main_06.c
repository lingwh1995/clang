 ...
 * 基于函数指针实现打印不同数据类型的数组
 *
 * 1. int类型指针可以转换为char类型指针，char类型指针也可以再反向转为int类型指针
 * 2. double类型指针可以转换为char类型指针，char类型指针也可以再反向转为double类型指针
 */

/**
 * 打印int类型数组
 */ 
void print_int_arr_3(const void *pv)
{
 ...
 * 打印double类型数组
 */ 
void print_double_arr_3(const void *pv)
{
 ...
 * 打印char类型数组
 */ 
void print_char_arr_3(const void *pv)
{
