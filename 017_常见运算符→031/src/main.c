...
void bitwise_operator()
{
	 ...
	 *
	 * c =   0	原码 => 0000 0000 0000 0000 0000 0000 0000 0000
	 ...
	 */
	int a = 15, b = -17, c = 0, d = 10;
	printf("a = %d, b = %d\n", a, b);

	/**
	 * 1. 与运算(全1则1，有0则0，可用于将某位置0) - & - AND
	 *
	 ...
	 *	  		结果 => 0
	 *
	 * 保留指定位 => & 指定保留的bit位为1，其余的bit位为0，可以用来快速获取最高位，有时会作为符号位使用(这里保留bit1、bit2)
	 *
	 * a =  15	补码 => 0000 0000 0000 0000 0000 0000 0000 1111
	 * 														 &
	 ...
	 * 或运算应用场景
	 *
	 * 设定数据的指定位，不会改变其他位 => 这里以 | 1 为例子
	 *
	 * c =  0	补码 => 0000 0000 0000 0000 0000 0000 0000 0000
	 * 														 |
	 * 		1	补码 => 0000 0000 0000 0000 0000 0000 0000 0001
	 * 														 =
	 * 	    	补码 => 0000 0000 0000 0000 0000 0000 0000 0001
	 ...
	 *	  		结果 => 1
	 *
	 * d =  10	补码 => 0000 0000 0000 0000 0000 0000 0000 1010
	 * 														 |
	 * 		10	补码 => 0000 0000 0000 0000 0000 0000 0000 1010
	 * 														 =
	 * 	    	补码 => 0000 0000 0000 0000 0000 0000 0000 1010
	 * 	    	反码 => 0000 0000 0000 0000 0000 0000 0000 1010
